...
namespace Matchmore.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Matches : List<Match>,  IEquatable<Matches>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as Matches);
        }

        /// <summary>
        /// Returns true if Matches instances are equal
        /// </summary>
        /// <param name="input">Instance of Matches to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Matches input)
        {
            if (input == null)
                return false;
