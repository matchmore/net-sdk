...
namespace Matchmore.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IBeaconTriple :  IEquatable<IBeaconTriple>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IBeaconTriple" /> class.
        /// </summary>
        /// <param name="DeviceId">The deviceId of the beacon. .</param>
        /// <param name="ProximityUUID">The UUID of the beacon, the purpose is to distinguish iBeacons in your network, from all other beacons in networks outside your control. .</param>
        /// <param name="Major">Major values are intended to identify and distinguish a group. .</param>
        /// <param name="Minor">Minor values are intended to identify and distinguish an individual. .</param>
        public IBeaconTriple(string DeviceId = default(string), string ProximityUUID = default(string), int? Major = default(int?), int? Minor = default(int?))
        {
        ...
        {
            return this.Equals(input as IBeaconTriple);
        }

        /// <summary>
        /// Returns true if IBeaconTriple instances are equal
        /// </summary>
        /// <param name="input">Instance of IBeaconTriple to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IBeaconTriple input)
        {
            if (input == null)
                return false;
