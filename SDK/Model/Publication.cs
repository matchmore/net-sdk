...
namespace Matchmore.Model
{
    ...
    public partial class Publication :  IEquatable<Publication>
    {
        ...
        /// Initializes a new instance of the <see cref="Publication" /> class.
        /// </summary>
        /// <param name="WorldId">The id (UUID) of the world that contains device to attach a publication to. (required).</param>
        /// <param name="DeviceId">The id (UUID) of the device to attach a publication to. (required).</param>
        /// <param name="Topic">The topic of the publication. This will act as a first match filter. For a subscription to be able to match a publication they must have the exact same topic.  (required).</param>
        /// <param name="Range">The range of the publication in meters. This is the range around the device holding the publication in which matches with subscriptions can be triggered.  (required).</param>
        /// <param name="Duration">The duration of the publication in seconds. If set to &#39;0&#39; it will be instant at the time of publication. Negative values are not allowed.  (required).</param>
        /// <param name="Properties">The dictionary of key, value pairs. Allowed values are number, boolean, string and array of aforementioned types (required).</param>
        public Publication(string WorldId = default(string), string DeviceId = default(string), string Topic = default(string), double? Range = default(double?), double? Duration = default(double?), Object Properties = default(Object))
        {
            // to ensure "WorldId" is required (not null)
            if (WorldId == null)
            {
                throw new InvalidDataException("WorldId is a required property for Publication and cannot be null");
            }
            else
            {
            ...
            if (DeviceId == null)
            {
                throw new InvalidDataException("DeviceId is a required property for Publication and cannot be null");
            }
            else
            {
            ...
            if (Topic == null)
            {
                throw new InvalidDataException("Topic is a required property for Publication and cannot be null");
            }
            else
            {
                this.Topic = Topic;
            ...
            if (Range == null)
            {
                throw new InvalidDataException("Range is a required property for Publication and cannot be null");
            }
            else
            {
                this.Range = Range;
            ...
            if (Duration == null)
            {
                throw new InvalidDataException("Duration is a required property for Publication and cannot be null");
            }
            else
            {
            ...
            if (Properties == null)
            {
                throw new InvalidDataException("Properties is a required property for Publication and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The duration of the publication in seconds. If set to &#39;0&#39; it will be instant at the time of publication. Negative values are not allowed. </value>
        ...
        /// </summary>
        /// <value>The dictionary of key, value pairs. Allowed values are number, boolean, string and array of aforementioned types</value>
