...
namespace Matchmore.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MobileDevice : Device,  IEquatable<MobileDevice>
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="MobileDevice" /> class.
        /// </summary>
        /// <param name="Platform">The platform of the device, this can be any string representing the platform type, for instance &#39;iOS&#39;.  (required).</param>
        /// <param name="DeviceToken">The deviceToken is the device push notification token given to this device by the OS, either iOS or Android for identifying the device with push notification services.  (required).</param>
        /// <param name="Location">Location (required).</param>
        public MobileDevice(string Platform = default(string), string DeviceToken = default(string), Location Location = default(Location), List<string> Group = default(List<string>), string Name = "", DeviceType DeviceType = DeviceType.MobileDevice) : base(Group, Name, DeviceType)
        {
            // to ensure "Platform" is required (not null)
            if (Platform == null)
            {
                throw new InvalidDataException("Platform is a required property for MobileDevice and cannot be null");
            }
            else
            {
            ...
            if (DeviceToken == null)
            {
                throw new InvalidDataException("DeviceToken is a required property for MobileDevice and cannot be null");
            }
            else
            {
            ...
            if (Location == null)
            {
                throw new InvalidDataException("Location is a required property for MobileDevice and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as MobileDevice);
        }

        /// <summary>
        /// Returns true if MobileDevice instances are equal
        /// </summary>
        /// <param name="input">Instance of MobileDevice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MobileDevice input)
        {
            if (input == null)
                return false;
