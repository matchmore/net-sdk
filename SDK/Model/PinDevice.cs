...
namespace Matchmore.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PinDevice : Device,  IEquatable<PinDevice>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PinDevice" /> class.
        /// </summary>
        ...
        public PinDevice(Location Location = default(Location), List<string> Group = default(List<string>), string Name = "", DeviceType DeviceType = DeviceType.PinDevice) : base(Group, Name, DeviceType)
        {
            // to ensure "Location" is required (not null)
            if (Location == null)
            {
                throw new InvalidDataException("Location is a required property for PinDevice and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PinDevice);
        }

        /// <summary>
        /// Returns true if PinDevice instances are equal
        /// </summary>
        /// <param name="input">Instance of PinDevice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PinDevice input)
        {
            if (input == null)
                return false;
