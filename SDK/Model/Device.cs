...
namespace Matchmore.Model
{
    ...
    /// </summary>
    [DataContract]
    //[JsonConverter(typeof(JsonSubtypes), "deviceType")]
    //[JsonSubtypes.KnownSubType(typeof(IBeaconDevice), "IBeaconDevice")]
    //[JsonSubtypes.KnownSubType(typeof(PinDevice), "PinDevice")]
    //[JsonSubtypes.KnownSubType(typeof(MobileDevice), "MobileDevice")]
    public partial class Device :  IEquatable<Device>
    {
        ...
        /// Initializes a new instance of the <see cref="Device" /> class.
        /// </summary>
        /// <param name="Group">Optional device groups, one device can belong to multiple groups, groups are string that can be max 25 characters long and contains letters numbers or underscores.</param>
        /// <param name="Name">The name of the device. (default to &quot;&quot;).</param>
        /// <param name="DeviceType">DeviceType (required).</param>
        public Device(List<string> Group = default(List<string>), string Name = "", DeviceType DeviceType = default(DeviceType))
        {
        ...
        /// </summary>
        /// <value>Optional device groups, one device can belong to multiple groups, groups are string that can be max 25 characters long and contains letters numbers or underscores</value>
