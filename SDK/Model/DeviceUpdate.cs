...
namespace Matchmore.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeviceUpdate :  IEquatable<DeviceUpdate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceUpdate" /> class.
        /// </summary>
        /// <param name="Name">New device name (optional).</param>
        /// <param name="DeviceToken">Token used for pushing matches. The token needs to be prefixed with &#x60;apns://&#x60; or &#x60;fcm://&#x60; dependent on the device or channel the match should be pushed with.</param>
        public DeviceUpdate(string Name = default(string), string DeviceToken = default(string))
        {
            this.Name = Name;
        ...
        {
            return this.Equals(input as DeviceUpdate);
        }

        /// <summary>
        /// Returns true if DeviceUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceUpdate input)
        {
            if (input == null)
                return false;
