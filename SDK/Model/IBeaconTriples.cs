...
namespace Matchmore.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IBeaconTriples : List<IBeaconTriple>,  IEquatable<IBeaconTriples>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IBeaconTriples" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public IBeaconTriples() : base()
        {
        }
        ...
        {
            return this.Equals(input as IBeaconTriples);
        }

        /// <summary>
        /// Returns true if IBeaconTriples instances are equal
        /// </summary>
        /// <param name="input">Instance of IBeaconTriples to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IBeaconTriples input)
        {
            if (input == null)
                return false;
